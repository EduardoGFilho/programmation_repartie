...
public class ServerTCPFileTransferBetter
{

    public static void main(String[] args) throws Exception
    {
        ServerTCPFileTransferBetter serverTCP = new ServerTCPFileTransferBetter();
        serverTCP.execute();
...
//        FileInputStream fis = new FileInputStream(inputPath);
        ...
        byte[] bufE = new String("size:" + fileSize + ";").getBytes();
